...
const SEARCH_DATA = [
    ...
    { title: 'renderer.showLoading()', route: '#/api', segment: 'metodos-del-renderer', category: 'Referencia', badge: 'warning', description: 'Muestra indicador de carga en resultados (renderer.showLoading)', keywords: 'showloading carga spinner indicator renderer' },
    ...
    { title: 'Pagination getRange()', route: '#/api', segment: 'pagination-getrange', category: 'Referencia', badge: 'warning', description: 'Retorna { from, to, total } del rango actual de paginación', keywords: 'getRange from to total rango paginacion' },
